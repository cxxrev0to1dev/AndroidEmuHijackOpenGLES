...
//  RedFinger:20170925{
    ADD_TYPE("GLsync", 32, "0x%x", false);
    ADD_TYPE("uint64_t", 64, "%lld", false);
    ADD_TYPE("uint32_t", 32, "%d", false);
    ADD_TYPE("GLuint64", 64, "%lld", false);
    ADD_TYPE("GLint64*", 64, "%lld", true);
    ADD_TYPE("float*", 32, "%p", true);
    ADD_TYPE("char**", 32, "%p", true);
    ADD_TYPE("char*", 32, "%p", true);
    ADD_TYPE("const char**", 32, "%p", true);
    ADD_TYPE("const char*", 32, "%p", true);
    ADD_TYPE("const GLvoid*const*", 32, "%p", true);
    ADD_TYPE("const GLchar*const*", 32, "%p", true);
    ADD_TYPE("uint32_t*", 32, "%p", true);
    ADD_TYPE("EGLint*", 32, "%p", true);
//  }RedFinger:20170925
}
