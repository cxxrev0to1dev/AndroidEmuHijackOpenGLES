...
# include $(EMUGL_PATH)/third_party/google-breakpad/Android.mk
include $(EMUGL_PATH)/third_party/google-breakpad/android/google_breakpad/Android.mk
...
######################################################################
include $(EMUGL_PATH)/system/libGLESv1_CM_RedFinger/Android.mk
include $(EMUGL_PATH)/system/libGLESv2_RedFinger/Android.mk
include $(EMUGL_PATH)/tests/ut_rendercontrol_enc/Android.mk
include $(EMUGL_PATH)/system/libEGL_RedFinger/Android.mk
######################################################################
