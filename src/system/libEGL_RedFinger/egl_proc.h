...
typedef __eglMustCastToProperFunctionPointerType (* eglGetProcAddress_t1) (const char*);
...
typedef EGLint (* eglWaitSyncKHR_t) (EGLDisplay dpy, EGLSyncKHR sync, EGLint flags);
typedef EGLClientBuffer (* eglGetRenderBufferANDROID_t) (EGLDisplay, EGLSurface);
typedef EGLint (* eglDupNativeFenceFDANDROID_t) (EGLDisplay dpy, EGLSyncKHR sync);
typedef EGLBoolean (* eglRenderBufferModifiedANDROID_t) (EGLDisplay dpy, EGLSurface draw);
typedef EGLuint64NV (* eglGetSystemTimeFrequencyNV_t) ();
typedef EGLuint64NV (* eglGetSystemTimeNV_t) ();
typedef EGLBoolean (* eglHibernateProcessIMG_t) ();
typedef EGLBoolean (* eglAwakenProcessIMG_t) ();


typedef void (* EGLSetBlobFuncANDROID_t) (const void *key, EGLsizeiANDROID keySize, const void *value, EGLsizeiANDROID valueSize);
typedef EGLsizeiANDROID (* EGLGetBlobFuncANDROID_t) (const void *key, EGLsizeiANDROID keySize, void *value, EGLsizeiANDROID valueSize);
typedef void (* eglSetBlobCacheFuncsANDROID_t)(EGLDisplay dpy, EGLSetBlobFuncANDROID_t set, EGLGetBlobFuncANDROID_t get);
