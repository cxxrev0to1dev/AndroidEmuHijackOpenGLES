...
static const struct _egl_funcs_by_name {
    ...
    {"eglWaitSyncKHR", (void *)eglWaitSyncKHR},
    //{"eglSetSwapRectangleANDROID",(void*)eglSetSwapRectangleANDROID},
    //{"eglGetRenderBufferANDROID", (void *)eglGetRenderBufferANDROID},
    {"eglDupNativeFenceFDANDROID", (void *)eglDupNativeFenceFDANDROID},
    //{"eglRenderBufferModifiedANDROID", (void *)eglRenderBufferModifiedANDROID},
    //{"eglGetSystemTimeFrequencyNV", (void *)eglGetSystemTimeFrequencyNV},
    //{"eglGetSystemTimeNV", (void *)eglGetSystemTimeNV},
    //{"eglHibernateProcessIMG", (void *)eglHibernateProcessIMG},
    //{"eglAwakenProcessIMG", (void *)eglAwakenProcessIMG},
    //{"eglSetBlobCacheFuncsANDROID", (void *)eglSetBlobCacheFuncsANDROID},
};
