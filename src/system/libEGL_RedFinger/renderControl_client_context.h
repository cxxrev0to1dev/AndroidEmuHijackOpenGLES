...
struct renderControl_client_context_t {
	...
	virtual rcCreateClientImage_client_proc_t set_rcCreateClientImage(rcCreateClientImage_client_proc_t f) { rcCreateClientImage_client_proc_t retval = rcCreateClientImage; rcCreateClientImage = f; return retval;}
	virtual rcDestroyClientImage_client_proc_t set_rcDestroyClientImage(rcDestroyClientImage_client_proc_t f) { rcDestroyClientImage_client_proc_t retval = rcDestroyClientImage; rcDestroyClientImage = f; return retval;}
	virtual rcSelectChecksumHelper_client_proc_t set_rcSelectChecksumHelper(rcSelectChecksumHelper_client_proc_t f) { rcSelectChecksumHelper_client_proc_t retval = rcSelectChecksumHelper; rcSelectChecksumHelper = f; return retval;}
	virtual rcCreateSyncKHR_client_proc_t set_rcCreateSyncKHR(rcCreateSyncKHR_client_proc_t f) { rcCreateSyncKHR_client_proc_t retval = rcCreateSyncKHR; rcCreateSyncKHR = f; return retval;}
	virtual rcClientWaitSyncKHR_client_proc_t set_rcClientWaitSyncKHR(rcClientWaitSyncKHR_client_proc_t f) { rcClientWaitSyncKHR_client_proc_t retval = rcClientWaitSyncKHR; rcClientWaitSyncKHR = f; return retval;}
	virtual rcFlushWindowColorBufferAsync_client_proc_t set_rcFlushWindowColorBufferAsync(rcFlushWindowColorBufferAsync_client_proc_t f) { rcFlushWindowColorBufferAsync_client_proc_t retval = rcFlushWindowColorBufferAsync; rcFlushWindowColorBufferAsync = f; return retval;}
	virtual rcDestroySyncKHR_client_proc_t set_rcDestroySyncKHR(rcDestroySyncKHR_client_proc_t f) { rcDestroySyncKHR_client_proc_t retval = rcDestroySyncKHR; rcDestroySyncKHR = f; return retval;}
	virtual rcSetPuid_client_proc_t set_rcSetPuid(rcSetPuid_client_proc_t f) { rcSetPuid_client_proc_t retval = rcSetPuid; rcSetPuid = f; return retval;}
	virtual rcUpdateColorBufferDMA_client_proc_t set_rcUpdateColorBufferDMA(rcUpdateColorBufferDMA_client_proc_t f) { rcUpdateColorBufferDMA_client_proc_t retval = rcUpdateColorBufferDMA; rcUpdateColorBufferDMA = f; return retval;}
	virtual rcCreateColorBufferDMA_client_proc_t set_rcCreateColorBufferDMA(rcCreateColorBufferDMA_client_proc_t f) { rcCreateColorBufferDMA_client_proc_t retval = rcCreateColorBufferDMA; rcCreateColorBufferDMA = f; return retval;}
