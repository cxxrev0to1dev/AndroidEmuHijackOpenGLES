...
struct egl_dispatch {
    ...
    eglGetProcAddress_t1 eglGetProcAddress;
    ...
    eglWaitSyncKHR_t eglWaitSyncKHR;
    eglGetRenderBufferANDROID_t eglGetRenderBufferANDROID;
    eglDupNativeFenceFDANDROID_t eglDupNativeFenceFDANDROID;
    eglRenderBufferModifiedANDROID_t eglRenderBufferModifiedANDROID;
    eglGetSystemTimeFrequencyNV_t eglGetSystemTimeFrequencyNV;
    eglGetSystemTimeNV_t eglGetSystemTimeNV;
    eglHibernateProcessIMG_t eglHibernateProcessIMG;
    eglAwakenProcessIMG_t eglAwakenProcessIMG;
    eglSetBlobCacheFuncsANDROID_t eglSetBlobCacheFuncsANDROID;
    void (*SetGLClientContext)(void* context);
    void (*SetGL2ClientContext)(void* context);
    void (*SetGL2ClientStateMakeCurrent)(void* context,void* state,int majorVersion,int minorVersion,int deviceMajorVersion,int deviceMinorVersion);
    void (*SetServerContext)(void* context);
    void (*InitState)(int major, int minor,int deviceMajor, int deviceMinor,GLClientState* state);

    void (*SetGLESv1EGLContext)(void* ctx);
    void* (*GetGLESv1CurrentEGLContext)();
    void (*SetGLESv1DecodeContext)(void* context);
    void (*SetGLESv1EncodeContext)(void* context);
    //Accessors
    ...
    eglGetProcAddress_t1 set_eglGetProcAddress(eglGetProcAddress_t1 f) { eglGetProcAddress_t1 retval = eglGetProcAddress; eglGetProcAddress = f; return retval;}
    ...
    eglSetSwapRectangleANDROID_t set_eglSetSwapRectangleANDROID(eglSetSwapRectangleANDROID_t f) { 
        eglSetSwapRectangleANDROID_t retval = eglSetSwapRectangleANDROID; 
        eglSetSwapRectangleANDROID = f; 
        return retval;
    }
    eglWaitSyncKHR_t set_eglWaitSyncKHR(eglWaitSyncKHR_t f){
        eglWaitSyncKHR_t retval = eglWaitSyncKHR; 
        eglWaitSyncKHR = f; 
        return retval;
    }
    eglGetRenderBufferANDROID_t set_eglGetRenderBufferANDROID(eglGetRenderBufferANDROID_t f){
        eglGetRenderBufferANDROID_t retval = eglGetRenderBufferANDROID; 
        eglGetRenderBufferANDROID = f; 
        return retval;
    }
    eglDupNativeFenceFDANDROID_t set_eglDupNativeFenceFDANDROID(eglDupNativeFenceFDANDROID_t f){
        eglDupNativeFenceFDANDROID_t retval = eglDupNativeFenceFDANDROID; 
        eglDupNativeFenceFDANDROID = f; 
        return retval;
    }
    eglRenderBufferModifiedANDROID_t set_eglRenderBufferModifiedANDROID(eglRenderBufferModifiedANDROID_t f){
        eglRenderBufferModifiedANDROID_t retval = eglRenderBufferModifiedANDROID; 
        eglRenderBufferModifiedANDROID = f; 
        return retval;
    }
    eglGetSystemTimeFrequencyNV_t set_eglGetSystemTimeFrequencyNV(eglGetSystemTimeFrequencyNV_t f){
        eglGetSystemTimeFrequencyNV_t retval = eglGetSystemTimeFrequencyNV; 
        eglGetSystemTimeFrequencyNV = f; 
        return retval;
    }
    eglGetSystemTimeNV_t set_eglGetSystemTimeNV(eglGetSystemTimeNV_t f){
        eglGetSystemTimeNV_t retval = eglGetSystemTimeNV; 
        eglGetSystemTimeNV = f; 
        return retval;
    }
    eglHibernateProcessIMG_t set_eglHibernateProcessIMG(eglHibernateProcessIMG_t f){
        eglHibernateProcessIMG_t retval = eglHibernateProcessIMG; 
        eglHibernateProcessIMG = f; 
        return retval;
    }
    eglAwakenProcessIMG_t set_eglAwakenProcessIMG(eglAwakenProcessIMG_t f){
        eglAwakenProcessIMG_t retval = eglAwakenProcessIMG; 
        eglAwakenProcessIMG = f; 
        return retval;
    }
    eglSetBlobCacheFuncsANDROID_t set_eglSetBlobCacheFuncsANDROID(eglSetBlobCacheFuncsANDROID_t f){
        eglSetBlobCacheFuncsANDROID_t retval = eglSetBlobCacheFuncsANDROID; 
        eglSetBlobCacheFuncsANDROID = f; 
        return retval;
    }
};
