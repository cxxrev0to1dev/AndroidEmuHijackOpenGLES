...
#include <stdio.h>
#include <stdlib.h>
#include "gles1_client_context.h"
#include "ErrorLog.h"
...
static gles1_client_context_t::CONTEXT_ACCESSOR_TYPE *getCurrentContext_client = NULL;
void gles1_client_context_t::setContextAccessor(CONTEXT_ACCESSOR_TYPE *f) { getCurrentContext_client = f; }
#define GET_CONTEXT_client gles1_client_context_t * ctx = getCurrentContext_client() 
#endif
