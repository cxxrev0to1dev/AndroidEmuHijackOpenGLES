...
#ifndef GUARD_gles1_encoder_context_t
#define GUARD_gles1_encoder_context_t
...
struct gles1_encoder_context_t : public gles1_client_context_t {

	IOStream *m_stream;

	gles1_encoder_context_t(IOStream *stream);
