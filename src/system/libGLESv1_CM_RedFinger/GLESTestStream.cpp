...
int TestStream::TestFully(const void *buf, size_t len){
    ...
    gles1_decoder_context_t* gles_decode = (gles1_decoder_context_t*)(decode_this_);
    ...
    if (RedFingerGLESv1Interception::IsInterceptionTargetOpcode(bbb,len)){
        RedFingerGLESv1Interception* gl_decode_interception = (RedFingerGLESv1Interception*)(gl_decodeInterception_this_);
        rvalue = gl_decode_interception->decode(bbb,len,writeback_class_);
    }
    else{
