...
// generated by 'emugen'
#ifndef __gles1_client_ftable_t_h
#define __gles1_client_ftable_t_h


static struct _gles1_funcs_by_name {
	const char *name;
	void *proc;
} gles1_funcs_by_name[] = {
...
static int gles1_num_funcs = sizeof(gles1_funcs_by_name) / sizeof(struct _gles1_funcs_by_name);
