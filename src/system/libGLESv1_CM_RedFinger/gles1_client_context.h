...
// generated by 'emugen'
#ifndef __gles1_client_context_t_h
#define __gles1_client_context_t_h

#include "gles1_client_proc.h"


struct gles1_client_context_t {
	...
	virtual glMultiDrawElementsSUN_client_proc_t set_glMultiDrawElementsSUN(glMultiDrawElementsSUN_client_proc_t f) { glMultiDrawElementsSUN_client_proc_t retval = glMultiDrawElementsSUN; glMultiDrawElementsSUN = f; return retval;}
	 virtual ~gles1_client_context_t() {}

	typedef gles1_client_context_t *CONTEXT_ACCESSOR_TYPE(void);
