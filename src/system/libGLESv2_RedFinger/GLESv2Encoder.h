...
*/
#ifndef __GLES_V2_ENCODER_H_
#define __GLES_V2_ENCODER_H_
...
class GLESv2Encoder : public gles_encoder_context_t {
public:
    GLESv2Encoder(IOStream *stream);
    virtual ~GLESv2Encoder();
    void initGL();
    ...
    gles_encoder_context_t* GetEncoder(){
        return (dynamic_cast<gles_encoder_context_t*>(this));
    }
