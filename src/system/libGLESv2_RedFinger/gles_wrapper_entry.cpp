...
static gles_wrapper_context_t::CONTEXT_ACCESSOR_TYPE *getCurrentContext_wrapper = NULL;
void gles_wrapper_context_t::setContextAccessor(CONTEXT_ACCESSOR_TYPE *f) { getCurrentContext_wrapper = f; }
#define GET_CONTEXT_wrapper gles_wrapper_context_t * ctx = getCurrentContext_wrapper() 
#endif
...
// void* glMapBufferOES(GLenum target, GLenum access)
// {
// 	ALOGD("run function:%s,%d,%p,%p\n",__func__,__LINE__,target,access);
// 	GET_CONTEXT_wrapper; 
...
const GLubyte* glGetStringi(GLenum name, GLuint index)
{
	return RedFinger_glGetStringi( name, index);
}
...
// by RedFinger tag:FuncInAEMUFuncs
	return RedFinger_glCreateShaderProgramv( type, count, var3);
}
